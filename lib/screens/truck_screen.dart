          ...
          child: Stack(
            children: <Widget>[
              ...
              Positioned(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: getContainerColor('sensor_3'),
                      border: Border.all(width: 1, color: Colors.black),
                      borderRadius: BorderRadius.all(Radius.circular(10)),
                    ),
                    child: Container(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    getSensorInformation('sensor_3')
                                                ?.pressureValue !=
                                            null
                                        ? '${getSensorInformation('sensor_3')?.pressureValue} PSI'
                                        : '--',
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 12),
                                  ),
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    getSensorInformation('sensor_3')
                                                ?.temperatureValue !=
                                            null
                                        ? '${getSensorInformation('sensor_3')?.temperatureValue} °C'
                                        : '--',
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 12),
                                  ),
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    getSensorInformation('sensor_3')?.battery !=
                                            null
                                        ? '${getSensorInformation('sensor_3')?.battery} V'
                                        : '--',
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 12),
                                  ),
              ...
              Positioned(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: getContainerColor('sensor_4'),
                      border: Border.all(width: 1, color: Colors.black),
                      borderRadius: BorderRadius.all(Radius.circular(10)),
                    ),
                    child: Container(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    getSensorInformation('sensor_4')
                                                ?.pressureValue !=
                                            null
                                        ? '${getSensorInformation('sensor_4')?.pressureValue} PSI'
                                        : '--',
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 12),
                                  ),
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    getSensorInformation('sensor_4')
                                                ?.temperatureValue !=
                                            null
                                        ? '${getSensorInformation('sensor_4')?.temperatureValue} °C'
                                        : '--',
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 12),
                                  ),
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    getSensorInformation('sensor_4')?.battery !=
                                            null
                                        ? '${getSensorInformation('sensor_4')?.battery} V'
                                        : '--',
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 12),
                                  ),
